...
export default class Contract {
    ...
    async new(options, privateKey = this.mcashWeb.defaultPrivateKey, callback = false) {
        ...
        try {
            ...
            const signedTransaction = await this.mcashWeb.trx.sign(transaction, privateKey);
            const contract = await this.mcashWeb.trx.sendRawTransaction(signedTransaction);
    ...
    async at(contractAddress, callback = false) {
        ...
        try {
            const contract = await this.mcashWeb.trx.getContract(contractAddress);
